export class Package {
    constructor(
        ...
        package_name: string,
        detail_a: string,
        detail_a_price: string,
        detail_b: string,
        detail_b_price: string,
        detail_c: string,
        detail_c_price: string,
        detail_d: string,
        detail_d_price: string,
        detail_e: string,
        detail_e_price: string,
        detail_f: string,
        detail_f_price: string,
        detail_g: string,
        detail_g_price: string,
        detail_h: string,
        detail_h_price: string,
        detail_j: string,
        detail_j_price: string,
        detail_k: string,
        detail_k_price: string,
        detail_l: string,
        detail_l_price: string,
        detail_m: string,
        detail_m_price: string,
