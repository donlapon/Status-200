...
7. Input traveller information
    ...
    #select date 
    press keys    none    ALT+ARROW_DOWN
    click element    xpath=/html/body/app-root/app-users-detail/div[2]/div/form/div[2]/div/div[2]/mat-form-field/div/div[1]/div[2]/mat-datepicker-toggle/button
...
12. Click I accept term & agreement button
    Set Selenium Speed    4 seconds
    Click Element    xpath=//*[@id="btn_accept"]
13. Wait until page contains payment information
